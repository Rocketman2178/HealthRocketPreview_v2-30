  ...
  return (
    <div className="bg-gray-800 rounded-lg p-6 shadow-xl">
      ...
      <p className="text-gray-300 text-center mb-6">
        Exclusive to 100 Gobundance Members
      </p>
        ...
        <div className="space-y-4">
          <div className="bg-gray-700/50 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-medium text-white">Free 60-day subscription</h3>
            </div>
          ...
          <div className="bg-gray-700/50 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-medium text-white">2,500 equity shares</h3>
            </div>
            <p className="text-sm text-gray-400">
              With a chance to win up to 100,000 shares
            </p>
          </div>
        </div>
